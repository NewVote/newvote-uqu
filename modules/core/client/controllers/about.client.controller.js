...
angular.module('core')
	.controller('AboutController', ['$scope', 'Authentication', '$mdSidenav', '$rootScope', '$mdMenu', '$state', 'SearchService', '$mdMedia', 'IssueService', 'SolutionService', 'ProposalService', '$timeout', 'Carousel',

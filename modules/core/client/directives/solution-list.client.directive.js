...
angular.module('core').directive('solutionList', ['$timeout', function ($timeout) {
	return {
		...
		controllerAs: 'vm',
		controller: ['$scope', '$window', '$state', 'VoteService', 'SortService', 'Authentication', 'SocialshareService', 'RegionService', 'SolutionService',
			function ($scope, $window, $state, VoteService, SortService, Authentication, SocialshareService, RegionService, SolutionService) {
				var vm = this;
